  ...
  try {
    ...
    await db.execute(sql`
      CREATE TABLE IF NOT EXISTS search_tasks (
        ...
        status ENUM('pending', 'running', 'completed', 'failed', 'stopped', 'insufficient_credits', 'service_busy') NOT NULL DEFAULT 'pending',
    ...
    await db.execute(sql`
      CREATE TABLE IF NOT EXISTS tps_search_tasks (
        ...
        status ENUM('pending', 'running', 'completed', 'failed', 'cancelled', 'insufficient_credits', 'service_busy') NOT NULL DEFAULT 'pending',
